...
class CardService extends BaseService_1.default {
    constructor() {
        super();
    ...
    getCards(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield this.cardController.getCards(iduser);
                res.status(200).json({
    ...
    createCard(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.cardController.createCard(req.body);
                res.status(200).json({
                    status: this.success.success,
                    message: this.success.message,
                    response
    ...
    updateCard(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield this.cardController.updateCard(req.body, cardId);
                res.status(200).json({
                    status: this.success.success,
                    message: this.success.message,
                    response
    ...
    deleteCard(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.cardController.deleteCard(req.params.idcard);
                res.status(200).json({
                    status: this.success.success,
                    message: this.success.message,
                    response
